---
title: "linear regression uncertainty"
output:
  learnr::tutorial:
    css: ['css/mycssblend.css']
description: "Learn how to sensibly build, interpret and predict from simple linear regression models with the emphasise on the uncertainty"
